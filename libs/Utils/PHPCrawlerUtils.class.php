...
class PHPCrawlerUtils
{
  ...
  public static function sort2dArray(&$array, $sort_args)
  {
    ...
    foreach ($array as $field => $field_val)
    {
  ...
  {                
    ...
    {
      $meta_name = (isset($matches[1][$x]) && $matches[1][$x] !== "" ? strtolower($matches[1][$x]) : "");
      $meta_value = (isset($matches[2][$x]) && $matches[2][$x] !== "" ? strtolower($matches[2][$x]) : "");
